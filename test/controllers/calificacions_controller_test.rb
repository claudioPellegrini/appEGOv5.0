...
class CalificacionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calificacion" do
    assert_difference('Calificacion.count') do
      post calificacions_url, params: { calificacion: { compra_id: @calificacion.compra_id, valor: @calificacion.valor } }
    end
  ...
  test "should update calificacion" do
    patch calificacion_url(@calificacion), params: { calificacion: { compra_id: @calificacion.compra_id, valor: @calificacion.valor } }
